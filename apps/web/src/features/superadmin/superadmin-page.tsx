...
import { api, ApiUser, ApiSupplier, PendingConsignment, ApiSettlement } from '@/lib/api';
...
import { SuperadminConsignmentOverview } from './components/superadmin-consignment-overview';
import { ConsignmentTab } from '@/features/consignment/consignment-tab';
import {
  Store, Plus, RefreshCw, LogOut, Loader2, X, CheckCircle2, AlertCircle,
...
import {
  Handshake, DollarSign, CreditCard, Wallet, Ban, Phone, Mail, ChevronDown, ChevronUp, Users, ShoppingBag, TrendingUp,
} from 'lucide-react';
            ...
            <table className="w-full text-sm">
              <thead className="sticky top-0 z-10">
                <tr className="border-b bg-gray-50">
                  {['Stores', 'Item', 'SKU', 'Category', 'Buying Price', "Wholesale Selling Price", 'NomadBite Price', 'Tax %', 'Stock'].map((h) => (
    ...
    <div className="max-w-xl space-y-6">
      ...
      <div className="bg-white border rounded-2xl p-6 space-y-4">
        ...
        <div className="space-y-4">
          <div className="flex gap-3 items-end">
            <div className="flex-1 space-y-1.5">
              <label className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Wholesale Markup %</label>
              <div className="relative">
                <input
        ...
        >
          {setVendorMutation.isPending
            ...
            : <><SlidersHorizontal className="h-4 w-4" /> Set Wholesale Prices</>
          }
        </button>
      </div>
...
export function SuperAdminPage() {
  ...
  type Tab = 'dashboard' | 'inventory' | 'pricing' | 'consignment';

  const TABS: { id: Tab; label: string; icon: JSX.Element }[] = [
    { id: 'dashboard', label: 'Dashboard', icon: <LayoutDashboard className="h-4 w-4" /> },
    { id: 'inventory', label: 'Inventory', icon: <Boxes className="h-4 w-4" /> },
    { id: 'pricing', label: 'Pricing', icon: <Percent className="h-4 w-4" /> },
    { id: 'consignment', label: 'Consignment', icon: <Handshake className="h-4 w-4" /> },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        {activeTab === 'consignment' && (
          <>
            <div>
              <h1 className="text-xl font-black">Consignment</h1>
              <p className="text-sm text-gray-500">Manage suppliers, track pay-on-sell payouts, and settle consignment balances</p>
            </div>
            <SuperadminConsignmentOverview />
            <ConsignmentTab />
          </>
        )}
